...
# 读取 Excel 文件
file_path = r'H:\icde异构图论文提交\data\消融等\numbershape.xlsx'  # 替换为您的文件路径
...
plt.xlabel('Shapelets', fontsize=20)  # 设置 x 轴标签字体大小
...
# 保存图形为图片文件
plt.savefig('shape.png', dpi=300, bbox_inches='tight')  # 保存为 PNG 文件，分辨率为 300 DPI
